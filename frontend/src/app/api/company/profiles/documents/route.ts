/**
 * Proxy API route for document management
...
export const GET = createApiRoute(COMPANY_API_URL, 'profiles/documents')
export const POST = createApiRoute(COMPANY_API_URL, 'profiles/documents')