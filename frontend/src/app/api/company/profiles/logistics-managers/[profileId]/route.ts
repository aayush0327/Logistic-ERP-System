/**
 * Proxy API route for logistics manager profile by ID
...
export const PUT = createApiRoute(COMPANY_API_URL, 'profiles/logistics-managers/[profileId]')
export const DELETE = createApiRoute(COMPANY_API_URL, 'profiles/logistics-managers/[profileId]')
