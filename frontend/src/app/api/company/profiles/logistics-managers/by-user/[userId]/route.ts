/**
 * Proxy API route for getting logistics manager profile by user ID
...
export const GET = createApiRoute(COMPANY_API_URL, 'profiles/logistics-managers/by-user/[userId]')
