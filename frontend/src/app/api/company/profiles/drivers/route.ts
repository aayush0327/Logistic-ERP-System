/**
 * Proxy API route for driver profiles
...
export const GET = createApiRoute(COMPANY_API_URL, 'profiles/drivers')
export const POST = createApiRoute(COMPANY_API_URL, 'profiles/drivers')