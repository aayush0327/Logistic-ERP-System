/**
 * Proxy API route for finance manager profile by ID
...
export const PUT = createApiRoute(COMPANY_API_URL, 'profiles/finance-managers/[profileId]')
export const DELETE = createApiRoute(COMPANY_API_URL, 'profiles/finance-managers/[profileId]')
