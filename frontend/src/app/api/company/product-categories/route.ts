/**
 * Proxy API route for product category operations
...
export const GET = createApiRoute(COMPANY_API_URL, 'product-categories/')
export const POST = createApiRoute(COMPANY_API_URL, 'product-categories/')