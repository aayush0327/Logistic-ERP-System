/**
 * Proxy API route for vehicle operations
...
export const GET = createApiRoute(COMPANY_API_URL, 'vehicles/')
export const POST = createApiRoute(COMPANY_API_URL, 'vehicles/')