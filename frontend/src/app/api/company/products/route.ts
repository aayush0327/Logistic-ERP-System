/**
 * Proxy API route for product operations
...
export const GET = createApiRoute(COMPANY_API_URL, 'products/')
export const POST = createApiRoute(COMPANY_API_URL, 'products/')