/**
 * Proxy API route for product unit type operations
...
export const GET = createApiRoute(COMPANY_API_URL, 'product-unit-types/')
export const POST = createApiRoute(COMPANY_API_URL, 'product-unit-types/')
