...
export default function DriverDashboard() {
  // State management - Only active trip and paused trip
  const [activeTrip, setActiveTrip] = useState<Trip | null>(null);
  const [pausedTrip, setPausedTrip] = useState<Trip | null>(null);
  const [activeTripDetail, setActiveTripDetail] = useState<DriverTripDetail | null>(null);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Paused Trip Section - Note: We won't display paused trips as they're not active */}
      {pausedTrip && (
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-black">
              ...
              <div>
                ...
                {activeTrip.completed_orders}/{activeTrip.total_orders} Orders
              </div>
              <div>
          ...
          {activeTripDetail && (
            <div className="border-t border-blue-200 pt-4">
              ...
              <div className="space-y-3">
                {activeTripDetail.orders.map((order) => {
                  const isPreviousOrderDelivered = activeTripDetail.orders
                        ...
                        {order.delivery_status === "delivered" ? (
                          ...
                          <button
                            onClick={() => {
                              ...
                              console.log("All trip orders:", activeTripDetail.orders);
