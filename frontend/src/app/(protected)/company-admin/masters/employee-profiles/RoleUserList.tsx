...
export default function RoleUserList({
  ...
  const filteredUsers = roleData.users.filter((user: UserWithProfile) => {
    if (filterStatus === "completed")
      return user.profile_completion?.is_complete === true;
  ...
  const completedUsers = roleData.users.filter(
          ...
          {filteredUsers.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              {filterStatus === "completed" &&
                "No completed profiles in this role"}
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          console.log(
                            "RoleUserList Button onClick - userId:",
                            userId,
                            "type:",
                            typeof userId
                          );
