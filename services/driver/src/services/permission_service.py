"""
Permission service for Driver Service - communicates with Auth Service
"""
...
class DriverServicePermission:
    """Permission service for Driver Service that fetches permissions from Auth Service"""
