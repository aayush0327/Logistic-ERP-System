"""
Permission service for Order Service - communicates with Auth Service
"""
...
class OrderServicePermission:
    """Permission service for Order Service that fetches permissions from Auth Service"""
