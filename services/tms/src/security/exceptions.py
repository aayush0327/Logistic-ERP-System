"""
Security-related exception handlers for TMS Service
"""
...
async def general_exception_handler(request: Request, exc: Exception) -> JSONResponse:
    ...
    # Check if it's an HTTPException and handle it appropriately
    ...
    # For other exceptions, log the full exception for debugging
    logger.error(
...
def log_security_event(
    ...
    logger.info(f"TMS_SECURITY_AUDIT: {event_type} - {message}", extra={"security_data": log_data})
