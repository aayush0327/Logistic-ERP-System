"""
Permission service for Finance Service - communicates with Auth Service
"""
...
class FinanceServicePermission:
    """Permission service for Finance Service that fetches permissions from Auth Service"""

    def __init__(self):
        self.auth_service_url = getattr(settings, 'AUTH_SERVICE_URL', "http://auth-service:8001")
...
permission_service = FinanceServicePermission()